...
class AssociatesBackground : BaseCharacterBackground() {
    ...
    fun getTooltip(tooltip: TooltipMakerAPI) {
        ...
        var label = tooltip.addPara(
                    "You start the game with four random executive officers of different aptitudes. Those officers can never be replaced or removed from your fleet. $text\n\n" +
        ...
        label.setHighlight("four random executive officers", "can never be replaced or removed", "additional skill point", "Combat", "30%", "This background is not recommended if this is your first time using the \"Second-in-Command\" mod." )
